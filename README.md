...
| ![AI 创作全流程](docs/演示素材/ai创作全流程.gif) | AI 写作Agent使用流程（从需求输入到文章生成的完整创作过程） | Plan-and-Execute 工作流、SSE 流式输出、进度实时推送 |
...
![AI 写作工作流](docs/演示素材/ai写作规划.gif)
> *用户输入写作需求 → 生成计划 → 确认 → 流式输出标题/摘要/正文 → 质量评估结果的完整流程*

![SmartAgent调用写作Agent全流程](docs/演示素材/AI助手调用写作agent完成全流程写作功能.gif)
...
![ES 搜索提示和高亮展示](docs/演示素材/es搜索提示和高亮展示.gif)
...
![实时通知截图](docs/演示素材/文章评论和ai审核通知.gif)
> *收到点赞/评论通知时前端的弹窗效果，展示 SSE 通知推送*

![私信聊天界面](docs/演示素材/私信功能和通知.gif)
