...
import com.personblog.api.messageAPI.ConversationApi;
...
public class ConversationServiceImpl extends ServiceImpl<ConversationMapper, Conversation> implements IConversationService, ConversationApi {
    ...
    public UnreadCountVO getUnreadCount(Long userId) {
        ...
        wrapper.eq(Conversation::getUserId, userId)
                .gt(Conversation::getUnreadCount, 0);
        ...
        return new UnreadCountVO(totalUnread);
    }
}
